				...
				<form method="post" action="./registerUser">
					<div class="mb-3">
						<label for="name">Nome</label> <input type="text"
							name="name" id="name_val" class="form-control" required>
					</div>
					<div class="mb-3">
						<label for="lastname">Cognome</label> <input type="text" min="0.0"
							step="0.01" name="lastname" id="lastname_val" class="form-control"
							required>
					</div>
					<div class="mb-3">
